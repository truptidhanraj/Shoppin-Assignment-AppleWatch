...
import "./index.css"
 ...
 const Footer = () => {
    ...
    const [showBandOptions, setShowBandOptions] = useState(false);
    ...
    return (
      <div className='footer-part'>
        ...
        <button className='button' onClick={handleBandClick} style={{flexGrow: showBandOptions ? 1 : 0,minWidth: showBandOptions ? "80px" : "auto"}}>
        <span><svg height="25" viewBox="0 0 10 25" width="10" xmlns="http://www.w3.org/2000/svg"><path d="m0 0h10v25h-10z" fill="none"></path><path d="m9.5 22.5a.5.5 0 0 1 -.5.5h-8a.5.5 0 1 1 0-1h.015a.485.485 0 0 0 .485-.485v-6.2216a4.5231 4.5231 0 0 0 1 .9448v5.2768a1.4779 1.4779 0 0 1 -.0813.485h5.1627a1.4758 1.4758 0 0 1 -.0814-.485v-5.2768a4.5209 4.5209 0 0 0 1-.9448v6.2216a.4851.4851 0 0 0 .4851.485h.0149a.5.5 0 0 1 .5.5zm-1.9194-19.5h-5.1621a1.4732 1.4732 0 0 1 .0815.485v9.015a2.5 2.5 0 0 0 5 0v-9.015a1.4873 1.4873 0 0 1 .0806-.485m1.4194-1a.5.5 0 0 1 .5.5.5.5 0 0 1 -.5.5h-.015a.485.485 0 0 0 -.485.485v9.015a3.5 3.5 0 0 1 -3.5 3.5 3.5 3.5 0 0 1 -3.5-3.5v-9.015a.485.485 0 0 0 -.485-.485h-.015a.5.5 0 0 1 0-1zm-3.2179 10.5a.75.75 0 1 0 -.75.75.75.75 0 0 0 .75-.75zm0-2.5a.75.75 0 1 0 -.75.75.75.75 0 0 0 .75-.75zm0-2.5a.75.75 0 1 0 -.75.75.75.75 0 0 0 .75-.75z" fill="#1d1d1f"></path></svg></span>
        {showBandOptions ? ( 
        <div className="band-options" style={{display:"flex"}}>
        ...
        Solo Loop</span>
        <span style={{marginRight:"10px"}}>
        Nike Sport Loop</span>
        <span style={{marginRight:"10px"}}>
        Nike Sport Band</span>
        </div> ) : ("Band")
        }
          </button>
      </div>
